"""Tests for personal_information_collector core module."""
...
class TestCollectionGuide:
    ...
    def test_collection_guide_has_required_fields(self):
        """Verify all required personal info fields are defined."""
        required_fields = [
            "full_name",
            "age",
            "languages",
    ...
    def test_activity_level_is_enum(self):
        """Verify activity_level is defined as enum."""
        assert "enum" in COLLECTION_GUIDE["activity_level"]["type"].lower()
